        ...
        <?php include('header.php')?>
            ...
            <section class="team-players">
                <article class="box-michael">
                    <h2>Michael</h2>
                    <div class="quote">
                        <p>"Forever young , profiter de la vie à fond et vivre de passions ! Croire en ses rêves ! Carpe Diem ! Ce qui ne me tue pas me rend plus fort #TeamKenzaFarah"</p>
                    </div>
                ...
                <article class ="box-therese">
                    <h2>Thérèse</h2>
                    <div class="quote">
                        <p>"Depuis que j'ai découvert Fishing World Pro Tour, je peux passer une après midi entière à pêcher sans sentir le poisson et la vase. C'est mon mari qui est content !"</p>
                    </div>
                ...
                <article class="box-richard">
                    <h2>Richard</h2>
                    <div class="quote">
                        <p>"À la base, j'étais sur EuroTruck mais j'avais personne avec qui jouer. Maintenant, j'attrape des poissons gros comme des camions mais je pollue moins. "</p>
                    </div>
            ...
            <section class="mapping">
                ...
                <div class="map">
                    <iframe src="https://www.google.com/maps/d/embed?mid=1Hr09jyH42qxuyb1vpmlcEhXUoFEvW_Lj" width="99%" height="480"></iframe>
                </div>
            </section>
